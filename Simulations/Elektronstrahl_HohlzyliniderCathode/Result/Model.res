...
lifetime=s:rebuild
result=s:1
files=s:ParticleSurfaceLosses_Cathode.gex
...
lifetime=s:rebuild
result=s:1
files=s:ParticleSurfaceLosses_Cathode.slim
...
lifetime=s:rebuild
result=s:1
files=s:ParticleSurfaceLosses_Cathode.sct
...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Es Solver\Charges\Cathode
files=s:EsSolver_Charges_Cathode.0d
...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Particle Sources\Virtual Gap Distance\Cathode
files=s:ParticleSources_VirtualGapDistance_Cathode.0d
...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Particle Sources\Charge vs. Iteration\Cathode
files=s:Cathode_charge.sig
...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Particle Sources\Current vs. Iteration\Cathode
files=s:Cathode_current.sig
...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Particle Sources\Perveance vs. Iteration\Cathode
files=s:Cathode_perveance.sig
...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Total Collision Information\Current\default: Cathode
files=s:TotalCollisionInformation_Current_default_Cathode.0d
...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Total Collision Information\Power\default: Cathode
files=s:TotalCollisionInformation_Power_default_Cathode.0d
...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Total Collision Information\Particles\default: Cathode
files=s:TotalCollisionInformation_Particles_default_Cathode.0d
...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\Particle Surface Collision Losses\Cathode
files=s:ParticleSurfaceLosses_Cathode.rex
ylabel=s:Particle Collision Surface Losses - Cathode
